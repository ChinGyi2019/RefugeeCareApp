...
// void sendSMS(
//     String message, List<String> recipients, double? lat, double? long) async {
...
//     String fullMessage = '$message $googleMapsUrl';
//     String encodedMessage = Uri.encodeComponent(fullMessage);
//     String smsUrl = 'sms:$_recipients?body=$encodedMessage';
...
class _EmergencySetupScreenState extends State<EmergencySetupScreen> {
  ...
  void initState() {
    ...
    Provider.of<EmergencySetupProvider>(context, listen: false).init();
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<EmergencySetupProvider>(context);
    return Scaffold(
        appBar: AppBar(
          elevation: 0,
  ...
  @override
  void dispose() {
    Provider.of<EmergencySetupProvider>(context, listen: true).clear();
    super.dispose();
  }
}
